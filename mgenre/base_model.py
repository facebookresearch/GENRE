...
class mGENREHubInterface(BARTHubInterface):
    ...
    def sample(
        ...
        tokenized_sentences = [
            torch.where(
                sentence < len(self.task.target_dictionary),
                sentence,
                torch.full_like(sentence, self.task.target_dictionary.unk_index),
            )
...
class mGENRE(BARTModel):
    ...
    def from_pretrained(
        ...
        sentencepiece_model="models/mbart.cc100/sentence.bpe.model",
        **kwargs,
    ):
